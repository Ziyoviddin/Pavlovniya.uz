...
const Service = () => {
  return (
    <div className='flex flex-col bg-teal-50 p-20 mt-5 '>
        ...
        <div className='grid grid-cols-2 max-md:grid-cols-1 justify-center max-[600px]:flex-col'>
            <div className='flex flex-row p-2 shadow-md shadow-[#363333] mt-4 mx-3 bg-[#f8faf9]'>
