  ...
  return (
    <div className='w-screen relative m-auto  max-[350px]:w-[400px]'>
        <div className={styles.clipDiv}>
            <div className='text-[#f4f8ed] sm:ml-6 m-auto'>
              <div className='max-sm:text-sm'>
                <h3 className='font-mono font-medium text-[#cfef97] mt-5 '>Нега Биз ?</h3>
                <h1 className='font-mono font-bold text-[#eceee1] tracking-tight max-[550px]:w-60  max-md:w-96'>Биздан килинган хариднинг афзалликлари:</h1>
              ...
              <div className='my-4'>
                <div className='flex flex-row max-[600px]:text-[8px] max-[1200px]:text-[12px] min-[600px]:mt-5'>
                  <div className='text-4xl text-[#f4f8ed] sm:mx-2'>
                    <RiNumber1/>
                  </div>
                  <div className='flex flex-col'>
                      <h3 className='font-bold font-sans text-[#cfef97] '>Ишончли Нав:</h3>
                      <p className='italic max-[670px]:w-40 max-[1200px]:w-[300px] w-[600px]'>Павловнияни жудахам куп турлари бор. Ёгоч махсулоти етиштириш учун, ишончли навни екиш мухимдир.</p>
                  </div>
                </div>
                <div className='flex flex-row max-[600px]:text-[8px] max-[1200px]:text-[12px] min-[600px]:mt-5'>
                  <div className='text-4xl text-[#f4f8ed] sm:mx-2'>
                  ...
                  <div className='flex flex-col '>
                      ...
                      <p className='italic max-[700px]:w-40 max-[1200px]:w-[300px] w-[600px]'>Хамёнбоп нархда  ва сифатли хизмат курсатишни бизнесимизни усиши учун асосиш омили деб биламиз.</p>
                  </div>
                </div>
                <div className='flex flex-row max-[600px]:text-[8px] max-[1200px]:text-[12px] min-[600px]:mt-5'>
                  <div className='text-4xl text-[#f4f8ed] sm:mx-2'>
